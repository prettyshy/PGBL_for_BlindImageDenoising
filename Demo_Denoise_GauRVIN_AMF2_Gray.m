    ...
    for SpikyRatio = [0.15 0.3]% 0.5
        for Sample=1:1
            ...
            for i =1:im_num
                ...
                fprintf('%s :\n',im_dir(i).name);
                imwrite(IMinAMF/255, ['../1_Results/NoisyImage/Noisy_AMF2_GauRVIN_' IMname '_' num2str(nSig) '_' num2str(SpikyRatio) '_' num2str(Sample) '.png']);
                %% denoising
                ...
                imwrite(Iout, ['VBPGBPFA_AMF2_GauRVIN_' IMname '_' num2str(nSig) '_' num2str(SpikyRatio) '_' num2str(Sample) '.png']);
            ...
            result = sprintf('VBPGBPFA_AMF2_GauRVIN_%d_%2.2f.mat',nSig,SpikyRatio);
